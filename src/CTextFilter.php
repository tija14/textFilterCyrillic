...
EOD;
	...
	public function toRussian($options){
	
		$rus  = array('а','б','в','г','д','e','ж','з','и','й','к','л','м','н','о','п','р','с','т','у', 
		...
		$text = "<b>Denna text: </b><br/>";
        $text .= str_replace($rus, $lat, $options);
		$text .= "<br/><b>blir på ryska: </b><br/> ";
        $text .= str_replace($lat, $rus, $options);
